...
public class WeatherData {
    ...
    public String lookUpWeather(String date, String time, String nx, String ny) throws IOException, JSONException {
        String baseDate = date; // 2023xxxx 형식을 사용해야 함
        ...
        // 일반 인증키
        String serviceKey = "9A9M5XxrGKcWn%2BsL1Fh9u2rw3efSPF%2F1UAIOV1Eg6Am9Dj6o6Eoh0Onc7kQj63mpUgkkALKPyg8ffFdnwmwD5A%3D%3D";
